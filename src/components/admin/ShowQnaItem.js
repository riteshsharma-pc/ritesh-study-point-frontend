    ...
    return (
        <>
            <tr>
                ...
                <td style={{ border: "1px solid black" }}> <input type="checkbox" checked={qna.imp} /> </td>
                ...
                <td style={{ border: "1px solid black" }}><button onClick={() => passCurrentQnAToModal(qna)}><i className="bi bi-pencil-square" /></button></td>
                <td style={{ border: "1px solid black" }}><button onClick={()=> deleteQnA(qna._id) }><i className="bi bi-trash3-fill"></i></button></td>
            </tr>
        </>
    )
}
